...
save(ghs2023, file = "../ghsdata/ghs2023.Rdata")
```
...
In this research, we estimate subjective poverty lines, based upon the minimum income question (MIQ), comparing them to National Treasury's objective money-metric poverty lines. We do so using two surveys from South Africa undertaken approximate 10 years apart [@lcs2014; @ghs2023] to see whether there have been any changes in subjective views of poverty over time, how much the subjective measures differ from the objective measures, and what those differences imply for poverty rates for different types of households. Our subjective poverty lines are underpinned by both linear parametric and nonparametric analyses that determine the intersection between actual and required income; see @Goedhartetal1977 or @ravallion2014poor for detials. Although their focus is an equivalence scales, @grodneretal2022, *offer useful information - like?* 

On the continent, such research is rare, @posel2014 considers subjective well-being as do @poselrogan2016, although their research is based on ladder-type questions (where respondents rank their living conditions as being representative of very poor to wealthy or they rate their satisfaction with life from very dissatisfied to very satisfied). @poselrogan2019, as far as we know, are the only ones to use MIQ in their analysis, although it was used to consider income aspirations -- whether or not household minimum required income exceeded their current income -- and how their reported minimum income correlated with objective/ subjective measures of economic standing, as well as their community's local economic conditions. On the other hand, @koch2022 estimates equivalence scales either from expenditure shares, while @koch2023 estimates subjective equivalence scales from consumption adequacy questions. Although any of the preceding analyses could have developed subjective poverty lines, none of them did.
