...
```{r lcs_hetiv, dependson="lcs"}

lcs_data <- lcs2014 

lcs_base <- lm(lnminq ~ lny + adults + kids +  age + age.sq +
                 hhh.male + ethnic + province + settle +
                 marital + education + month + grants,
               data=lcs_data)
# Cluster-robust vcov
...
lcs_kidiv <- hetErrorsIV(lnminq ~ lny + adults +  age + 
                           age.sq + hhh.male + ethnic + province +
...
lcs_adiv <- hetErrorsIV(lnminq ~ lny + kids +  age + 
                           age.sq + hhh.male + ethnic + province +
                           settle + marital + education + month +
...
ghs_base <- lm(lnminq ~ lny + adults + kids +  age + age.sq +
                 hhh.male + ethnic + province + settle +
                 marital + education + month + grants,
               data=ghs_data)
# Cluster-robust vcov
...
ghs_kidiv <- hetErrorsIV(lnminq ~ lny + adults +  age + 
                           age.sq + hhh.male + ethnic + province +
                           settle + marital + education + month +
                           grants + kids | kids | 
                           IIV(age, grants, lny),
...
ghs_adiv <- hetErrorsIV(lnminq ~ lny  + kids +  age + 
                           age.sq + hhh.male + ethnic + province +
                           settle + marital + education + month +
                           grants + adults | adults | 
                           IIV(age, grants, lny),
